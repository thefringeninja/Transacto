...
public class ExceptionCentricTestSpecification {
	...
	public ExceptionCentricTestResult Fail(Exception actual) {
		...
		return new ExceptionCentricTestResult(this, TestResultState.Failed, new Optional<Exception>(actual),
			Optional<Fact[]>.Empty);
	}
	...
	/// <returns>
	///     <c>true</c> if the specified <see cref="ExceptionCentricTestSpecification" /> is equal to this instance; otherwise,
	///     <c>false</c>.
	/// </returns>
